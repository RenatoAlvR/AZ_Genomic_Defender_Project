...
# Generate data
generated_data = model.generate(num_samples=15000, poison_factor=0.0, batch_size=250).cpu().numpy()
...
# Save and visualize
output_dir = Path('data/GSE161529/possible_cancer/generated_30k')
